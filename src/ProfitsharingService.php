...
class ProfitsharingService extends BaseService
{
     ...
     * @throws Exception
     */
    public function addReceiver(string $account, ?string $name = null): mixed
    {
     ...
     * @throws Exception
     */
    public function deleteReceiver(string $account): mixed
    {
     ...
     * @throws Exception
     */
    public function submit(string $out_order_no, string $transaction_id, string $openid, string $name, int $amount): mixed
    {
     ...
     * @throws Exception
     */
    public function query(string $out_order_no, string $transaction_id): mixed
    {
     ...
     * @throws Exception
     */
    public function unfreeze(string $out_order_no, string $transaction_id): mixed
    {
     ...
     * @throws Exception
     */
    public function orderAmountQuery(string $transaction_id): mixed
    {
     ...
     * @throws Exception
     */
    public function return(array $params): mixed
    {
     ...
     * @throws Exception
     */
    public function returnQuery(string $out_return_no, string $out_order_no): mixed
    {
