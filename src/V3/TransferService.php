...
class TransferService extends BaseService
{
     ...
     * @throws Exception
     */
    public function transferbatch(string $batch_id, array $params = []): mixed
    {
        if (empty($batch_id)) {
            throw new Exception('微信批次单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferdetail(string $batch_id, string $detail_id): mixed
    {
        if (empty($batch_id) || empty($detail_id)) {
            throw new Exception('微信批次单号和微信明细单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferoutbatch(string $out_batch_no, array $params = []): mixed
    {
        if (empty($out_batch_no)) {
            throw new Exception('商家批次单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferoutdetail(string $out_batch_no, string $out_detail_no): mixed
    {
        if (empty($out_batch_no) || empty($out_detail_no)) {
            throw new Exception('商家批次单号和商家明细单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferBatchReceiptApply(string $out_batch_no): mixed
    {
        if (empty($out_batch_no)) {
            throw new Exception('商家批次单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferBatchReceiptQuery(string $out_batch_no): mixed
    {
        if (empty($out_batch_no)) {
            throw new Exception('商家批次单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferDetailReceiptApply(string $out_batch_no, string $out_detail_no): mixed
    {
        if (empty($out_batch_no) || empty($out_detail_no)) {
            throw new Exception('商家批次单号和商家明细单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferDetailReceiptQuery(string $out_batch_no, string $out_detail_no): mixed
    {
        if (empty($out_batch_no) || empty($out_detail_no)) {
            throw new Exception('商家批次单号和商家明细单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function mchTransfer(array $params): mixed
    {
        if (empty($params)) {
            throw new Exception('请求参数不能为空');
        }
     ...
     * @throws Exception
     */
    public function cancelTransfer(string $out_bill_no): mixed
    {
        if (empty($out_bill_no)) {
     ...
     * @throws Exception
     */
    public function queryTransferByOutNo(string $out_bill_no): mixed
    {
        if (empty($out_bill_no)) {
            throw new Exception('商户单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function queryTransfer(string $transfer_bill_no): mixed
    {
        if (empty($transfer_bill_no)) {
            throw new Exception('微信单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferReceiptApply(string $out_bill_no): mixed
    {
        if (empty($out_bill_no)) {
            throw new Exception('商户单号不能为空');
        }
     ...
     * @throws Exception
     */
    public function transferReceiptQuery(string $out_bill_no): mixed
    {
        if (empty($out_bill_no)) {
            throw new Exception('商户单号不能为空');
        }
