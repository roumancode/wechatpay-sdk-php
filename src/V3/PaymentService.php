...
class PaymentService extends BaseService
{
     ...
     * @throws Exception
     */
    public function refundQuery(string $out_refund_no): mixed
    {
     ...
     * @throws Exception
     */
    public function tradeBill(array $params): mixed
    {
     ...
     * @throws Exception
     */
    public function fundflowBill(array $params): mixed
    {
     ...
     * @throws Exception
     */
    public function combineNativePay(array $params): mixed
    {
     ...
     * @throws Exception
     */
    public function combineH5Pay(array $params): mixed
    {
     ...
     * @throws Exception
     */
    public function combineAppPay(array $params): mixed
    {
     ...
     * @throws Exception
     */
    public function combineQueryOrder(string $combine_out_trade_no): mixed
    {
     ...
     * @throws Exception
     */
    public function combineCloseOrder(string $combine_out_trade_no, array $out_trade_no_list): mixed
    {
